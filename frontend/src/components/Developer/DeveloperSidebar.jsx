...
const DeveloperSidebar = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .catch(() => {
        // ❌ Pehle yahan localStorage.clear() tha, jo admin token bhi uda deta tha.
        // ✅ Ab sirf developer ka data clear hoga.
  ...
  const logout = () => {
    // ❌ Pehle yahan localStorage.clear() tha, jo admin ko bhi logout kar deta tha.
    // ✅ Ab sirf developer ka data delete hoga, admin active rahega.
    localStorage.removeItem("devToken");
    localStorage.removeItem("devData"); 
    navigate("/developer/login");
  };
